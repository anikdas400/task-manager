import {
  ...
  import logo from '../../assets/png-transparent-red-file-icon-computer-icons-directory-file-folders-red-folder-directory-icon-miscellaneous-rectangle-apple-icon-image-format.png';
